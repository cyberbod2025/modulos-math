  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-cyan-500/30 pb-20">
      <header className="bg-slate-900/80 backdrop-blur-md border-b border-slate-800 py-4 px-6 shadow-[0_4px_30px_rgba(0,0,0,0.5)] sticky top-0 z-50">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-4 w-full sm:w-auto">
            ...
            <h1 className="text-xl font-bold tracking-tight text-slate-100 hidden sm:block">Multiplicación</h1>
          </div>
      ...
      <main className="max-w-5xl mx-auto p-4 sm:p-6 flex flex-col items-center mt-4">
        ...
        {/* Type Selector */}
        <div className="flex bg-slate-900 p-1 rounded-xl border border-slate-800 mb-8 shadow-lg">
          <button
        ...
        {/* Visualization Stage */}
        {(mode === 'explore' || (mode === 'practice' && step > 0)) && (
                ...
                {step < 3 ? (
                  Array.from({ length: wholeNumber }).map((_, i) => (
                    <motion.div
                      ...
                      className="relative bg-white rounded-xl shadow-[0_0_20px_rgba(255,255,255,0.1)] border-2 border-slate-700 overflow-hidden"
